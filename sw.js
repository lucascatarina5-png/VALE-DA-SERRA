const CACHE='vale-da-serra-v171-conversa-natural';
const ASSETS=['/v163-debt-view.js','/v166-mobile.js','/v167-mascot-events.js','/v171-mascot-assistant.js','/manifest.webmanifest','/icon-192.png','/icon-512.png','/icon-maskable-192.png','/icon-maskable-512.png','/mobile-hero-v82.png','/icon-estoque-realista.png','/icon-produtor-leite-realista.png','/v155-tank-core.js','/v157-mobile.css','/v157-mobile.js','/v133-galpao-inteligente.js','/v160-ui.css','/v160-ui.js'];
